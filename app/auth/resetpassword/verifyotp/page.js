...
import { verifyOtpAction } from '@/app/action/UserAction';
const Page = () => {
        ...
        <div className='w-full flex flex-col justify-evenly items-center gap-8'>
                <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center gap-4'>
                    <div className="relative w-full">
                        ...
                        <h2 className="text-xl text-[#9D9D9D]">OTP</h2>
                        </div>
                    </div>
                    <button type='submit' className="w-full rounded-xl bg-[#E53835] text-white text-2xl p-4">
                                <h2>Send OTP</h2>
                    </button>
                </form>
        </div>
