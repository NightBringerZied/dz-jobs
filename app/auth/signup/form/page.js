            ...
            <div className='w-[40%] h-[90%]  flex flex-col justify-between items-start relative max-md:hidden'>
                <div className='flex flex-col justify-around items-center w-[40%] gap-10'>
                    <img src='/logoauth.png' alt='logo'/>
                          <h2 className='text-3xl font-bold text-white w-[70%]'> Welcome to Job-DZ !
                                where we make 
                                things easy for you 
                          </h2>
                </div>
                <img src='/signup.png' alt='signin' className='absolute overflow-hidden right-[-30%] bottom-[-10%]'/>
            </div>
                            ...
                            <div className="relative w-full">
                                ...
                                <div
                                  className={`absolute left-3 flex items-center space-x-2 transition-all duration-300 
                                    ${name ? "top-0 -translate-y-full text-sm text-black" : "peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500"} 
              ...
              <div className='w-[60%] flex flex-col h-[40%] justify-around items-center'>
                      ...
                      <div className='flex flex-row justify-between items-center w-full'>
                                  <div className='flex flex-row justify-center items-center'>
                                        <h5 className='text-xl text-gray-500'>Already have an Account ?</h5><hr/>
                                        <Link href={"/auth/signin"} className='text-xl text-[#66BB69]'>Sign In</Link>
                                  </div>
                      </div>
              </div>
            </div>
