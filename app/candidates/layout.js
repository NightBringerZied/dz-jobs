  ...
  return (
    <div className="flex h-screen ">
      <aside
        ...
        ${
          isSidebarOpen ? " w-[70px] " : "-translate-x-full lg:w-[200px] "
      ...
      >
        <div className="flex flex-col">
          ...
          <nav className="mt-4 flex flex-col items-center justify-center gap-5 w-full py-6 border-b-2 border-[#27AE60]">
            <Ha
              ...
              title={"Profile Mangaments"}
              notselectedimg={"/profile.png"}
              selectedimg={"/profile.png"}
              isopen={isSidebarOpen}
            />
            <Ha
              href="/candidates/jobsearch"
              title={"Job Search "}
              notselectedimg={"/jobsearch.png"}
              selectedimg={"/greenjob.png"}
              isopen={isSidebarOpen}
            />
            <Ha
              href="/candidates/jobapplication"
              title={"Job Application "}
              notselectedimg={"/jobappli.png"}
              selectedimg={"/greenjob.png"}
              isopen={isSidebarOpen}
            />
            <Ha
              href="/candidates/favorite"
              title={"Favorite "}
              notselectedimg={"/favorite.png"}
              selectedimg={"/favorite.png"}
              isopen={isSidebarOpen}
            />
          </nav>
        </div>
        <div className="flex flex-col justify-around py-6 items-start">
          <div className="mt-4 flex flex-col items-center justify-center gap-5 w-full py-6 ">
            <Ha
              href="/candidates/setting"
              title={"Setting"}
              notselectedimg={"/setting.png"}
              selectedimg={"/setting.png"}
              isopen={isSidebarOpen}
            />
            <Ha
              href="/candidates/Faq"
              title={"FAQ"}
              notselectedimg={"/FAQ.png"}
              selectedimg={"/FAQ.png"}
              isopen={isSidebarOpen}
            />
          </div>
          <div className="flex flex-row items-center justify-evenly w-full py-6 ">
            ...
            />
            {!isSidebarOpen && (
              <h1 className="text-xl text-[#888888] font-light">
                zied Benaliouche
              </h1>
            )}
            {!isSidebarOpen && (
      ...
      <div className="flex-1 flex flex-col ">
        <header
          className={`bg-white border-b-2 border-[#27AE60]  shadow-2xl ${
            isSidebarOpen ? "w-full pl-[80px]" : "lg:pl-[220px] w-full "
          } h-[60px] text-[#95a1af] px-4 flex justify-between items-center`}
        >
          <div className="flex flex-row justify-center items-center   gap-4 ">
            ...
            <h1 className="text-2xl text-[#27AE60] font-semibold ">
              {pathName}
            </h1>
          </div>
        ...
        <main
          className={`flex-1 ${
            isSidebarOpen ? "pl-[80px]" : "lg:pl-[220px]"
          } overflow-y-auto overflow-x-hidden bg-[#f6f7fb]`}
        >
          {children}
        </main>
      </div>
